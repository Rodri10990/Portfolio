      ...
      {open ? (
        ...
        >
          ...
          <motion.div
            ...
            className="relative z-[1] flex max-h-[min(90vh,900px)] w-full max-w-3xl flex-col overflow-hidden rounded-xl border border-[#10b981] bg-black shadow-[0_0_0_1px_rgba(16,185,129,0.35),0_0_42px_rgba(16,185,129,0.22)]"
          ...
          >
            <header className="flex items-center gap-4 border-b border-emerald-500/20 px-5 py-3">
              ...
              <p id={titleId} className="min-w-0 flex-1 truncate font-terminal text-xs text-emerald-500/95 sm:text-sm">
                ~/projects/README.md
              </p>
              {sourceRepoUrl ? (
                <a
                  ...
                  className="inline-flex max-w-[9rem] shrink-0 truncate rounded-md border border-emerald-500/35 bg-emerald-500/10 px-2 py-1 font-terminal text-[10px] font-medium text-emerald-400 transition-colors hover:border-emerald-400/55 hover:bg-emerald-500/15 sm:max-w-none sm:px-2.5 sm:text-[11px]"
                >
                  GitHub
                </a>
              ) : null}
              <button
                type="button"
                onClick={() => closeReadme()}
                className="-mr-2 rounded-full p-2 text-emerald-500/85 transition-colors hover:bg-emerald-500/10 hover:text-emerald-400"
            ...
            {(phase === "ready" || phase === "error") && (
              <footer className="border-t border-emerald-500/10 px-5 py-3 font-terminal text-xs text-emerald-500">
