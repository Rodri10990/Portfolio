...
export function MacbookScrollShowcase() {
  ...
  return (
    <div ref={ref} className="relative">
      <motion.div style={{ rotateX, scale, y }} className="mx-auto min-w-0 w-full max-w-5xl" aria-label="El Kaiser showcase">
          ...
          <div className="rounded-[1.15rem] border border-neutral-700 bg-black p-3 sm:rounded-[1.5rem] sm:p-6">
            <div className="mb-3 flex flex-col gap-3 sm:mb-4 sm:flex-row sm:items-start sm:justify-between">
              <div>
                ...
                <h3 className="mt-1 break-words text-base font-semibold text-white [overflow-wrap:anywhere] sm:text-xl">
                  Ops & Financial Visibility
                </h3>
              </div>
            ...
            <div className="grid gap-2.5 sm:grid-cols-3 sm:gap-3">
              <div className="min-w-0 rounded-xl border border-emerald-500/30 bg-neutral-950 p-3">
